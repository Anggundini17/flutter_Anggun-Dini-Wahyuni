          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Consumer<DatabaseManager>(
              builder: (context, manager, child) {
                ...
                final useState = manager.state;

                if (useState == ContactViewState.loading) {
                  return const Center(
                    child: CircularProgressIndicator(),
                  );
                } else if (useState == ContactViewState.loaded) {
                        ...
                        trailing: Wrap(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () async {
                                final selectedContact = await manager
                                    .getContactById(contactData.id!);
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                  ...
                  return const Center(
                    child: Text('Error occurred while loading contacts'),
                  );
                }
              },
            ),
